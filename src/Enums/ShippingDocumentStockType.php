...
class ShippingDocumentStockType
{
    ...
    /**
     * Constant for value 'PAPER_4_PER_PAGE_PORTRAIT'
     * @return string 'PAPER_4_PER_PAGE_PORTRAIT'
     */
    const VALUE_PAPER_4_PER_PAGE_PORTRAIT = 'PAPER_4_PER_PAGE_PORTRAIT';
    /**
     ...
     * @uses self::VALUE_PAPER_4_PER_PAGE_PORTRAIT
    ...
    public static function getValidValues()
    {
        return array(
            ...
            self::VALUE_PAPER_4_PER_PAGE_PORTRAIT,
