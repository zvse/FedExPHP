...
class LocationSearchFilterType
{
    ...
    /**
     * Constant for value 'EXCLUDE_UNAVAILABLE_LOCATIONS'
     * @return string 'EXCLUDE_UNAVAILABLE_LOCATIONS'
     */
    const VALUE_EXCLUDE_UNAVAILABLE_LOCATIONS = 'EXCLUDE_UNAVAILABLE_LOCATIONS';
    /**
     ...
     * @uses self::VALUE_EXCLUDE_UNAVAILABLE_LOCATIONS
     * @return string[]
     */
    public static function getValidValues()
    {
        return array(
            ...
            self::VALUE_EXCLUDE_UNAVAILABLE_LOCATIONS,
        );
    }
    /**
