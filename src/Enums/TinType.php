...
class TinType
{
    ...
    /**
     * Constant for value 'BUSINESS_UNION'
     * @return string 'BUSINESS_UNION'
     */
    const VALUE_BUSINESS_UNION = 'BUSINESS_UNION';
    /**
     ...
     * @uses self::VALUE_BUSINESS_UNION
