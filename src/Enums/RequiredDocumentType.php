...
/**
 * This class stands for RequiredDocumentType Enums
 * Meta informations extracted from the WSDL
 * - documentation: This identifies the document types that can be required. This can also indicate when either a COMMERCIAL_INVOICE or a PRO_FORMA_INVOICE is required through the COMMERCIAL_OR_PRO_FORMA_INVOICE option.
...
class RequiredDocumentType
{
    ...
    /**
     * Constant for value 'COMMERCIAL_OR_PRO_FORMA_INVOICE'
     * @return string 'COMMERCIAL_OR_PRO_FORMA_INVOICE'
     */
    const VALUE_COMMERCIAL_OR_PRO_FORMA_INVOICE = 'COMMERCIAL_OR_PRO_FORMA_INVOICE';
    /**
     ...
     * @uses self::VALUE_COMMERCIAL_OR_PRO_FORMA_INVOICE
    ...
    public static function getValidValues()
    {
        return array(
            ...
            self::VALUE_COMMERCIAL_OR_PRO_FORMA_INVOICE,
