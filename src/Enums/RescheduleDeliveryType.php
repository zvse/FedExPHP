...
/**
 * This class stands for RescheduleDeliveryType Enums
 * Meta informations extracted from the WSDL
 * - documentation: Specifies the ways to reschedule the delivery of a shipment.
 * @subpackage Enumerations
 */
class RescheduleDeliveryType
{
    /**
