...
/**
 * This class stands for RequestedConsolidationDocumentType Enums
 * @subpackage Enumerations
 */
class RequestedConsolidationDocumentType
{
    /**
    ...
    /**
     * Constant for value 'CONSOLIDATED_PARTY_REPORT'
     * @return string 'CONSOLIDATED_PARTY_REPORT'
     */
    const VALUE_CONSOLIDATED_PARTY_REPORT = 'CONSOLIDATED_PARTY_REPORT';
    /**
     ...
     * @uses self::VALUE_CONSOLIDATED_PARTY_REPORT
    ...
    public static function getValidValues()
    {
        return array(
            ...
            self::VALUE_CONSOLIDATED_PARTY_REPORT,
