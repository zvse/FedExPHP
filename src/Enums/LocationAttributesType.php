...
class LocationAttributesType
{
    ...
    /**
     * Constant for value 'EXPRESS_FREIGHT_DROPOFFS'
     * @return string 'EXPRESS_FREIGHT_DROPOFFS'
     */
    const VALUE_EXPRESS_FREIGHT_DROPOFFS = 'EXPRESS_FREIGHT_DROPOFFS';
    /**
     * Constant for value 'EXPRESS_PARCEL_DROPOFFS'
     * @return string 'EXPRESS_PARCEL_DROPOFFS'
     */
    const VALUE_EXPRESS_PARCEL_DROPOFFS = 'EXPRESS_PARCEL_DROPOFFS';
    /**
     * Constant for value 'FEDEX_FREIGHT_DROPOFFS'
     * @return string 'FEDEX_FREIGHT_DROPOFFS'
     */
    const VALUE_FEDEX_FREIGHT_DROPOFFS = 'FEDEX_FREIGHT_DROPOFFS';
    /**
     * Constant for value 'GROUND_DROPOFFS'
     * @return string 'GROUND_DROPOFFS'
     */
    const VALUE_GROUND_DROPOFFS = 'GROUND_DROPOFFS';
    /**
     * Constant for value 'GROUND_HOME_DELIVERY_DROPOFFS'
     * @return string 'GROUND_HOME_DELIVERY_DROPOFFS'
     */
    const VALUE_GROUND_HOME_DELIVERY_DROPOFFS = 'GROUND_HOME_DELIVERY_DROPOFFS';
    /**
    ...
    /**
     * Constant for value 'SAME_DAY_CITY_DROPOFFS'
     * @return string 'SAME_DAY_CITY_DROPOFFS'
     */
    const VALUE_SAME_DAY_CITY_DROPOFFS = 'SAME_DAY_CITY_DROPOFFS';
    /**
     * Constant for value 'SAME_DAY_DROPOFFS'
     * @return string 'SAME_DAY_DROPOFFS'
     */
    const VALUE_SAME_DAY_DROPOFFS = 'SAME_DAY_DROPOFFS';
    /**
     * Constant for value 'SATURDAY_DROPOFFS'
     * @return string 'SATURDAY_DROPOFFS'
     */
    const VALUE_SATURDAY_DROPOFFS = 'SATURDAY_DROPOFFS';
    /**
     * Constant for value 'SATURDAY_EXPRESS_HOLD_AT_LOCATION'
     * @return string 'SATURDAY_EXPRESS_HOLD_AT_LOCATION'
     */
    const VALUE_SATURDAY_EXPRESS_HOLD_AT_LOCATION = 'SATURDAY_EXPRESS_HOLD_AT_LOCATION';
    /**
     * Constant for value 'SHIP_AND_GET'
     * @return string 'SHIP_AND_GET'
     */
    const VALUE_SHIP_AND_GET = 'SHIP_AND_GET';
    /**
    ...
    /**
     * Constant for value 'VIDEO_CONFERENCING'
     * @return string 'VIDEO_CONFERENCING'
     */
    const VALUE_VIDEO_CONFERENCING = 'VIDEO_CONFERENCING';
    /**
     * Constant for value 'WEEKDAY_EXPRESS_HOLD_AT_LOCATION'
     * @return string 'WEEKDAY_EXPRESS_HOLD_AT_LOCATION'
     */
    const VALUE_WEEKDAY_EXPRESS_HOLD_AT_LOCATION = 'WEEKDAY_EXPRESS_HOLD_AT_LOCATION';
    /**
     * Constant for value 'WEEKDAY_GROUND_HOLD_AT_LOCATION'
     * @return string 'WEEKDAY_GROUND_HOLD_AT_LOCATION'
     */
    const VALUE_WEEKDAY_GROUND_HOLD_AT_LOCATION = 'WEEKDAY_GROUND_HOLD_AT_LOCATION';
    /**
     ...
     * @uses self::VALUE_EXPRESS_FREIGHT_DROPOFFS
     * @uses self::VALUE_EXPRESS_PARCEL_DROPOFFS
     * @uses self::VALUE_FEDEX_FREIGHT_DROPOFFS
     * @uses self::VALUE_GROUND_DROPOFFS
     * @uses self::VALUE_GROUND_HOME_DELIVERY_DROPOFFS
     ...
     * @uses self::VALUE_SAME_DAY_CITY_DROPOFFS
     * @uses self::VALUE_SAME_DAY_DROPOFFS
     * @uses self::VALUE_SATURDAY_DROPOFFS
     * @uses self::VALUE_SATURDAY_EXPRESS_HOLD_AT_LOCATION
     * @uses self::VALUE_SHIP_AND_GET
     * @uses self::VALUE_SIGNS_AND_BANNERS_SERVICE
     * @uses self::VALUE_SONY_PICTURE_STATION
     * @uses self::VALUE_VIDEO_CONFERENCING
     * @uses self::VALUE_WEEKDAY_EXPRESS_HOLD_AT_LOCATION
     * @uses self::VALUE_WEEKDAY_GROUND_HOLD_AT_LOCATION
     * @return string[]
     */
    public static function getValidValues()
    {
        return array(
            ...
            self::VALUE_DROP_BOX,
            self::VALUE_EXPRESS_FREIGHT_DROPOFFS,
            self::VALUE_EXPRESS_PARCEL_DROPOFFS,
            self::VALUE_FEDEX_FREIGHT_DROPOFFS,
            self::VALUE_GROUND_DROPOFFS,
            self::VALUE_GROUND_HOME_DELIVERY_DROPOFFS,
            ...
            self::VALUE_SAME_DAY_CITY_DROPOFFS,
            self::VALUE_SAME_DAY_DROPOFFS,
            self::VALUE_SATURDAY_DROPOFFS,
            self::VALUE_SATURDAY_EXPRESS_HOLD_AT_LOCATION,
            self::VALUE_SHIP_AND_GET,
            self::VALUE_SIGNS_AND_BANNERS_SERVICE,
            self::VALUE_SONY_PICTURE_STATION,
            self::VALUE_VIDEO_CONFERENCING,
            self::VALUE_WEEKDAY_EXPRESS_HOLD_AT_LOCATION,
            self::VALUE_WEEKDAY_GROUND_HOLD_AT_LOCATION,
        );
    }
    /**
