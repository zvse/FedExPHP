 ...
 * @subpackage Services
 */
class LocationsService extends AbstractSoapClientBase
{
    ...
    public function __construct(array $wsdlOptions = array(), $resetSoapClient = true, $mode = 'test')
    {
        ...
        $default_options = [
           \WsdlToPhp\PackageBase\AbstractSoapClientBase::WSDL_URL => dirname(__FILE__).DIRECTORY_SEPARATOR.'wsdl-'.$mode.DIRECTORY_SEPARATOR.'LocationsService_v11.wsdl',
        ...
        $this->version = new \NicholasCreativeMedia\FedExPHP\Structs\VersionId('locs',11,0,0);
    }
    /**
