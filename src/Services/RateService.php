...
class RateService extends AbstractSoapClientBase
{
    ...
    public function __construct(array $wsdlOptions = array(), $resetSoapClient = true, $mode = 'test')
    {
        ...
        $default_options = [
           \WsdlToPhp\PackageBase\AbstractSoapClientBase::WSDL_URL => dirname(__FILE__).DIRECTORY_SEPARATOR.'wsdl-'.$mode.DIRECTORY_SEPARATOR.'RateService_v26.wsdl',
        ...
        $this->version = new \NicholasCreativeMedia\FedExPHP\Structs\VersionId('crs',26,0,0);
    }
    /**
