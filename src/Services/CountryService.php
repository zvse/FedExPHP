 ...
 * @subpackage Services
 */
class CountryService extends AbstractSoapClientBase
{
    ...
    public function __construct(array $wsdlOptions = array(), $resetSoapClient = true, $mode = 'test')
    {
        ...
        $default_options = [
           \WsdlToPhp\PackageBase\AbstractSoapClientBase::WSDL_URL => dirname(__FILE__).DIRECTORY_SEPARATOR.'wsdl-'.$mode.DIRECTORY_SEPARATOR.'CountryService_v8.wsdl',
        ...
        $this->version = new \NicholasCreativeMedia\FedExPHP\Structs\VersionId('cnty',8,0,0);
    }
    /**
