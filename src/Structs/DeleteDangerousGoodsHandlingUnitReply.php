...
/**
 * This class stands for DeleteDangerousGoodsHandlingUnitReply Structs
 * Meta informations extracted from the WSDL
 * - type: ns:DeleteDangerousGoodsHandlingUnitReply
 * @subpackage Structs
 */
class DeleteDangerousGoodsHandlingUnitReply extends AbstractStructBase
{
    /**
     * The HighestSeverity
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for DeleteDangerousGoodsHandlingUnitReply
     * @uses DeleteDangerousGoodsHandlingUnitReply::setHighestSeverity()
     * @uses DeleteDangerousGoodsHandlingUnitReply::setNotifications()
     * @uses DeleteDangerousGoodsHandlingUnitReply::setVersion()
     * @uses DeleteDangerousGoodsHandlingUnitReply::setTransactionDetail()
     * @uses DeleteDangerousGoodsHandlingUnitReply::setCompletedShipmentDetail()
     ...
     */
    public function __construct($highestSeverity = null, array $notifications = array(), \CommerceFedEx\FedExPHP\Structs\VersionId $version = null, \CommerceFedEx\FedExPHP\Structs\TransactionDetail $transactionDetail = null, \CommerceFedEx\FedExPHP\Structs\CompletedDangerousGoodsShipmentDetail $completedShipmentDetail = null)
    {
        $this
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\DeleteDangerousGoodsHandlingUnitReply
     */
    ...
    {
        foreach ($notifications as $deleteDangerousGoodsHandlingUnitReplyNotificationsItem) {
            // validation for constraint: itemType
            if (!$deleteDangerousGoodsHandlingUnitReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($deleteDangerousGoodsHandlingUnitReplyNotificationsItem) ? get_class($deleteDangerousGoodsHandlingUnitReplyNotificationsItem) : gettype($deleteDangerousGoodsHandlingUnitReplyNotificationsItem)), __LINE__);
            }
        }
