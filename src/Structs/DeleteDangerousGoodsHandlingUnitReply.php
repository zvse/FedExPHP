...
class DeleteDangerousGoodsHandlingUnitReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\DeleteDangerousGoodsHandlingUnitReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $deleteDangerousGoodsHandlingUnitReplyNotificationsItem) {
            ...
            if (!$deleteDangerousGoodsHandlingUnitReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($deleteDangerousGoodsHandlingUnitReplyNotificationsItem) ? get_class($deleteDangerousGoodsHandlingUnitReplyNotificationsItem) : gettype($deleteDangerousGoodsHandlingUnitReplyNotificationsItem)), __LINE__);
            }
        }
