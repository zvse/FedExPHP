...
class RecipientCustomsId extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \CommerceFedEx\FedExPHP\Enums\RecipientCustomsIdType::valueIsValid()
     * @uses \CommerceFedEx\FedExPHP\Enums\RecipientCustomsIdType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \CommerceFedEx\FedExPHP\Structs\RecipientCustomsId
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\CommerceFedEx\FedExPHP\Enums\RecipientCustomsIdType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \CommerceFedEx\FedExPHP\Enums\RecipientCustomsIdType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
