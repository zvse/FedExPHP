...
/**
 * This class stands for ModifyDangerousGoodsHandlingUnitReply Structs
 * Meta informations extracted from the WSDL
 * - type: ns:ModifyDangerousGoodsHandlingUnitReply
 * @subpackage Structs
 */
class ModifyDangerousGoodsHandlingUnitReply extends AbstractStructBase
{
    /**
     * The HighestSeverity
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ModifyDangerousGoodsHandlingUnitReply
     * @uses ModifyDangerousGoodsHandlingUnitReply::setHighestSeverity()
     * @uses ModifyDangerousGoodsHandlingUnitReply::setNotifications()
     * @uses ModifyDangerousGoodsHandlingUnitReply::setVersion()
     * @uses ModifyDangerousGoodsHandlingUnitReply::setTransactionDetail()
     * @uses ModifyDangerousGoodsHandlingUnitReply::setCompletedShipmentDetail()
     * @uses ModifyDangerousGoodsHandlingUnitReply::setCompletedHandlingUnitGroup()
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\ModifyDangerousGoodsHandlingUnitReply
     */
    ...
    {
        foreach ($notifications as $modifyDangerousGoodsHandlingUnitReplyNotificationsItem) {
            // validation for constraint: itemType
            if (!$modifyDangerousGoodsHandlingUnitReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($modifyDangerousGoodsHandlingUnitReplyNotificationsItem) ? get_class($modifyDangerousGoodsHandlingUnitReplyNotificationsItem) : gettype($modifyDangerousGoodsHandlingUnitReplyNotificationsItem)), __LINE__);
            }
        }
     ...
     * @return \CommerceFedEx\FedExPHP\Structs\ModifyDangerousGoodsHandlingUnitReply
     */
    public function setCompletedHandlingUnitGroup(\CommerceFedEx\FedExPHP\Structs\CompletedDangerousGoodsHandlingUnitGroup $completedHandlingUnitGroup = null)
    {
