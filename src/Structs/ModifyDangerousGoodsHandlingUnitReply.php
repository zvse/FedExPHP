...
class ModifyDangerousGoodsHandlingUnitReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\ModifyDangerousGoodsHandlingUnitReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $modifyDangerousGoodsHandlingUnitReplyNotificationsItem) {
            ...
            if (!$modifyDangerousGoodsHandlingUnitReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($modifyDangerousGoodsHandlingUnitReplyNotificationsItem) ? get_class($modifyDangerousGoodsHandlingUnitReplyNotificationsItem) : gettype($modifyDangerousGoodsHandlingUnitReplyNotificationsItem)), __LINE__);
            }
        }
