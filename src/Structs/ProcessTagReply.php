...
class ProcessTagReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\ProcessTagReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $processTagReplyNotificationsItem) {
            ...
            if (!$processTagReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($processTagReplyNotificationsItem) ? get_class($processTagReplyNotificationsItem) : gettype($processTagReplyNotificationsItem)), __LINE__);
            }
        }
