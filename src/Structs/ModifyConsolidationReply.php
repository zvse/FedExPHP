...
class ModifyConsolidationReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\ModifyConsolidationReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $modifyConsolidationReplyNotificationsItem) {
            ...
            if (!$modifyConsolidationReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($modifyConsolidationReplyNotificationsItem) ? get_class($modifyConsolidationReplyNotificationsItem) : gettype($modifyConsolidationReplyNotificationsItem)), __LINE__);
            }
        }
