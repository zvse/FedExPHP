...
/**
 * This class stands for ModifyConsolidationReply Structs
 * Meta informations extracted from the WSDL
 * - type: ns:ModifyConsolidationReply
 * @subpackage Structs
 */
class ModifyConsolidationReply extends AbstractStructBase
{
    /**
     * The HighestSeverity
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ModifyConsolidationReply
     * @uses ModifyConsolidationReply::setHighestSeverity()
     * @uses ModifyConsolidationReply::setNotifications()
     * @uses ModifyConsolidationReply::setVersion()
     * @uses ModifyConsolidationReply::setTransactionDetail()
     * @uses ModifyConsolidationReply::setRequestedConsolidation()
     ...
     */
    public function __construct($highestSeverity = null, array $notifications = array(), \CommerceFedEx\FedExPHP\Structs\VersionId $version = null, \CommerceFedEx\FedExPHP\Structs\TransactionDetail $transactionDetail = null, \CommerceFedEx\FedExPHP\Structs\RequestedConsolidation $requestedConsolidation = null)
    {
        $this
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\ModifyConsolidationReply
     */
    ...
    {
        foreach ($notifications as $modifyConsolidationReplyNotificationsItem) {
            // validation for constraint: itemType
            if (!$modifyConsolidationReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($modifyConsolidationReplyNotificationsItem) ? get_class($modifyConsolidationReplyNotificationsItem) : gettype($modifyConsolidationReplyNotificationsItem)), __LINE__);
            }
        }
