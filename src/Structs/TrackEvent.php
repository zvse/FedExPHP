...
class TrackEvent extends AbstractStructBase
{
     ...
     * @uses TrackEvent::setBarcodeEntryType()
     ...
     */
    public function __construct($timestamp = null, $eventType = null, $eventDescription = null, $statusExceptionCode = null, $statusExceptionDescription = null, $barcodeEntryType = null, \NicholasCreativeMedia\FedExPHP\Structs\Address $address = null, $stationId = null, $arrivalLocation = null)
    {
        $this
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Enums\BarcodeEntryType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Enums\BarcodeEntryType::getValidValues()
    ...
    public function setBarcodeEntryType($barcodeEntryType = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Enums\BarcodeEntryType::valueIsValid($barcodeEntryType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $barcodeEntryType, implode(', ', \NicholasCreativeMedia\FedExPHP\Enums\BarcodeEntryType::getValidValues())), __LINE__);
        }
