...
/**
 * This class stands for OperationalDocumentPart Structs
 * Meta informations extracted from the WSDL
 * - documentation: A single part of an operational document, such as one page of a multiple-page document whose format requires a separate image per page.
 * @subpackage Structs
 */
class OperationalDocumentPart extends AbstractStructBase
{
    /**
    ...
    public $Image;
    /**
     * Constructor method for OperationalDocumentPart
     * @uses OperationalDocumentPart::setDocumentPartSequenceNumber()
     * @uses OperationalDocumentPart::setImage()
     ...
     * @param int $documentPartSequenceNumber
     * @return \NicholasCreativeMedia\FedExPHP\Structs\OperationalDocumentPart
     */
