...
class ConsolidatedSoldToSummaryReportDetail extends AbstractStructBase
{
     ...
     * Set Format value
     * @param \NicholasCreativeMedia\FedExPHP\Structs\ShippingDocumentFormat $format
     * @return \NicholasCreativeMedia\FedExPHP\Structs\ConsolidatedSoldToSummaryReportDetail
     */
    ...
    public function setCustomerImageUsages(array $customerImageUsages = array())
    {
        foreach ($customerImageUsages as $consolidatedSoldToSummaryReportDetailCustomerImageUsagesItem) {
            ...
            if (!$consolidatedSoldToSummaryReportDetailCustomerImageUsagesItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\CustomerImageUsage) {
                throw new \InvalidArgumentException(sprintf('The CustomerImageUsages property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\CustomerImageUsage, "%s" given', is_object($consolidatedSoldToSummaryReportDetailCustomerImageUsagesItem) ? get_class($consolidatedSoldToSummaryReportDetailCustomerImageUsagesItem) : gettype($consolidatedSoldToSummaryReportDetailCustomerImageUsagesItem)), __LINE__);
            }
        }
