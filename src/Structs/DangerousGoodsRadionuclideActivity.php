...
/**
 * This class stands for DangerousGoodsRadionuclideActivity Structs
 * @subpackage Structs
 */
class DangerousGoodsRadionuclideActivity extends AbstractStructBase
{
    /**
     * The Value
    ...
    /**
     * Constructor method for DangerousGoodsRadionuclideActivity
     * @uses DangerousGoodsRadionuclideActivity::setValue()
     * @uses DangerousGoodsRadionuclideActivity::setUnitOfMeasure()
     * @param float $value
