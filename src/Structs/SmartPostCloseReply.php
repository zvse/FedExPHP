...
class SmartPostCloseReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\SmartPostCloseReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $smartPostCloseReplyNotificationsItem) {
            ...
            if (!$smartPostCloseReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($smartPostCloseReplyNotificationsItem) ? get_class($smartPostCloseReplyNotificationsItem) : gettype($smartPostCloseReplyNotificationsItem)), __LINE__);
            }
        }
