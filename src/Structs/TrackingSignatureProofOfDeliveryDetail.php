...
/**
 * This class stands for TrackingSignatureProofOfDeliveryDetail Structs
 * @subpackage Structs
 */
class TrackingSignatureProofOfDeliveryDetail extends AbstractStructBase
{
    /**
     * The DocumentFormat
    ...
    /**
     * Constructor method for TrackingSignatureProofOfDeliveryDetail
     * @uses TrackingSignatureProofOfDeliveryDetail::setDocumentFormat()
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Structs\TrackingDocumentFormat $documentFormat
     * @return \NicholasCreativeMedia\FedExPHP\Structs\TrackingSignatureProofOfDeliveryDetail
     */
