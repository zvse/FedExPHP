...
class RetrievePackageInOpenShipmentReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\RetrievePackageInOpenShipmentReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $retrievePackageInOpenShipmentReplyNotificationsItem) {
            ...
            if (!$retrievePackageInOpenShipmentReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($retrievePackageInOpenShipmentReplyNotificationsItem) ? get_class($retrievePackageInOpenShipmentReplyNotificationsItem) : gettype($retrievePackageInOpenShipmentReplyNotificationsItem)), __LINE__);
            }
        }
