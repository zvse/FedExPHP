...
/**
 * This class stands for CrnReportDetail Structs
 * Meta informations extracted from the WSDL
 * - documentation: The instructions indicating how to print the Child Reference Number document.
 * @subpackage Structs
 */
class CrnReportDetail extends AbstractStructBase
{
    /**
     * The Format
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for CrnReportDetail
