...
class ValidateDeliveryReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\ValidateDeliveryReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $validateDeliveryReplyNotificationsItem) {
            ...
            if (!$validateDeliveryReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($validateDeliveryReplyNotificationsItem) ? get_class($validateDeliveryReplyNotificationsItem) : gettype($validateDeliveryReplyNotificationsItem)), __LINE__);
            }
        }
