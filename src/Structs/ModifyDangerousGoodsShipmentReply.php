...
class ModifyDangerousGoodsShipmentReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\ModifyDangerousGoodsShipmentReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $modifyDangerousGoodsShipmentReplyNotificationsItem) {
            ...
            if (!$modifyDangerousGoodsShipmentReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($modifyDangerousGoodsShipmentReplyNotificationsItem) ? get_class($modifyDangerousGoodsShipmentReplyNotificationsItem) : gettype($modifyDangerousGoodsShipmentReplyNotificationsItem)), __LINE__);
            }
        }
