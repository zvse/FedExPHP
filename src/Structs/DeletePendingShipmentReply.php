...
class DeletePendingShipmentReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\DeletePendingShipmentReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $deletePendingShipmentReplyNotificationsItem) {
            ...
            if (!$deletePendingShipmentReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($deletePendingShipmentReplyNotificationsItem) ? get_class($deletePendingShipmentReplyNotificationsItem) : gettype($deletePendingShipmentReplyNotificationsItem)), __LINE__);
            }
        }
