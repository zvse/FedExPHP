...
class GroundCloseReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\GroundCloseReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $groundCloseReplyNotificationsItem) {
            ...
            if (!$groundCloseReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($groundCloseReplyNotificationsItem) ? get_class($groundCloseReplyNotificationsItem) : gettype($groundCloseReplyNotificationsItem)), __LINE__);
            }
        }
     ...
     * @return \CommerceFedEx\FedExPHP\Structs\GroundCloseReply
     */
    public function setManifest(\CommerceFedEx\FedExPHP\Structs\ManifestFile $manifest = null)
    {
