...
/**
 * This class stands for CondensedCrnReportDetail Structs
 * Meta informations extracted from the WSDL
 * - documentation: The instructions indicating how to print the short form of the Child Reference Number document.
 * @subpackage Structs
 */
class CondensedCrnReportDetail extends AbstractStructBase
{
    /**
     * The Format
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for CondensedCrnReportDetail
     * @uses CondensedCrnReportDetail::setFormat()
     * @uses CondensedCrnReportDetail::setCustomerImageUsages()
     * @uses CondensedCrnReportDetail::setSignatureName()
     ...
     * Set Format value
     * @param \NicholasCreativeMedia\FedExPHP\Structs\ShippingDocumentFormat $format
     * @return \NicholasCreativeMedia\FedExPHP\Structs\CondensedCrnReportDetail
     */
    ...
    {
        foreach ($customerImageUsages as $condensedCrnReportDetailCustomerImageUsagesItem) {
            // validation for constraint: itemType
            if (!$condensedCrnReportDetailCustomerImageUsagesItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\CustomerImageUsage) {
                throw new \InvalidArgumentException(sprintf('The CustomerImageUsages property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\CustomerImageUsage, "%s" given', is_object($condensedCrnReportDetailCustomerImageUsagesItem) ? get_class($condensedCrnReportDetailCustomerImageUsagesItem) : gettype($condensedCrnReportDetailCustomerImageUsagesItem)), __LINE__);
            }
        }
