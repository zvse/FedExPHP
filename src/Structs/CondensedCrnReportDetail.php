...
class CondensedCrnReportDetail extends AbstractStructBase
{
     ...
     * Set Format value
     * @param \CommerceFedEx\FedExPHP\Structs\ShippingDocumentFormat $format
     * @return \CommerceFedEx\FedExPHP\Structs\CondensedCrnReportDetail
     */
    ...
    public function setCustomerImageUsages(array $customerImageUsages = array())
    {
        foreach ($customerImageUsages as $condensedCrnReportDetailCustomerImageUsagesItem) {
            ...
            if (!$condensedCrnReportDetailCustomerImageUsagesItem instanceof \CommerceFedEx\FedExPHP\Structs\CustomerImageUsage) {
                throw new \InvalidArgumentException(sprintf('The CustomerImageUsages property can only contain items of \CommerceFedEx\FedExPHP\Structs\CustomerImageUsage, "%s" given', is_object($condensedCrnReportDetailCustomerImageUsagesItem) ? get_class($condensedCrnReportDetailCustomerImageUsagesItem) : gettype($condensedCrnReportDetailCustomerImageUsagesItem)), __LINE__);
            }
        }
