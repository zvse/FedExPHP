...
/**
 * This class stands for AddDangerousGoodsHandlingUnitRequest Structs
 * Meta informations extracted from the WSDL
 * - type: ns:AddDangerousGoodsHandlingUnitRequest
 * @subpackage Structs
 */
class AddDangerousGoodsHandlingUnitRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for AddDangerousGoodsHandlingUnitRequest
     * @uses AddDangerousGoodsHandlingUnitRequest::setWebAuthenticationDetail()
     * @uses AddDangerousGoodsHandlingUnitRequest::setClientDetail()
     * @uses AddDangerousGoodsHandlingUnitRequest::setVersion()
     * @uses AddDangerousGoodsHandlingUnitRequest::setTransactionDetail()
     * @uses AddDangerousGoodsHandlingUnitRequest::setUploadId()
     * @uses AddDangerousGoodsHandlingUnitRequest::setHandlingUnitGroup()
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Structs\WebAuthenticationDetail $webAuthenticationDetail
     * @return \NicholasCreativeMedia\FedExPHP\Structs\AddDangerousGoodsHandlingUnitRequest
     */
