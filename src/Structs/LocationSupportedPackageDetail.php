...
/**
 * This class stands for LocationSupportedPackageDetail Structs
 * @subpackage Structs
 */
class LocationSupportedPackageDetail extends AbstractStructBase
{
    /**
     * The Weight
    ...
    public $Dimensions;
    /**
     * Constructor method for LocationSupportedPackageDetail
     * @uses LocationSupportedPackageDetail::setWeight()
     * @uses LocationSupportedPackageDetail::setDimensions()
     ...
     * Set Weight value
     * @param \NicholasCreativeMedia\FedExPHP\Structs\Weight $weight
     * @return \NicholasCreativeMedia\FedExPHP\Structs\LocationSupportedPackageDetail
     */
