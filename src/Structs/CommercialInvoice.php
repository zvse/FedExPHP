...
class CommercialInvoice extends AbstractStructBase
{
    ...
    public $Purpose;
    /**
     * The PurposeOfShipmentDescription
     * Meta informations extracted from the WSDL
     * - documentation: Not exposed to Web Services customers; only present for use in mapping from CTS transactions.
     * - minOccurs: 0
     * @var string
     */
    public $PurposeOfShipmentDescription;
    /**
     ...
     * @uses CommercialInvoice::setPurposeOfShipmentDescription()
     ...
     */
    public function __construct(array $comments = array(), \NicholasCreativeMedia\FedExPHP\Structs\Money $freightCharge = null, \NicholasCreativeMedia\FedExPHP\Structs\Money $taxesOrMiscellaneousCharge = null, $taxesOrMiscellaneousChargeType = null, \NicholasCreativeMedia\FedExPHP\Structs\Money $packingCosts = null, \NicholasCreativeMedia\FedExPHP\Structs\Money $handlingCosts = null, $specialInstructions = null, $declarationStatement = null, $paymentTerms = null, $purpose = null, $purposeOfShipmentDescription = null, array $customerReferences = array(), $originatorName = null, $termsOfSale = null)
    {
        $this
            ...
            ->setPurpose($purpose)
            ->setPurposeOfShipmentDescription($purposeOfShipmentDescription)
    ...
    /**
     * Get PurposeOfShipmentDescription value
     * @return string|null
     */
    public function getPurposeOfShipmentDescription()
    {
        return $this->PurposeOfShipmentDescription;
    }
    /**
     * Set PurposeOfShipmentDescription value
     * @param string $purposeOfShipmentDescription
     * @return \NicholasCreativeMedia\FedExPHP\Structs\CommercialInvoice
     */
    public function setPurposeOfShipmentDescription($purposeOfShipmentDescription = null)
    {
        // validation for constraint: string
        if (!is_null($purposeOfShipmentDescription) && !is_string($purposeOfShipmentDescription)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($purposeOfShipmentDescription)), __LINE__);
        }
