...
class SignatureProofOfDeliveryFaxReply extends AbstractStructBase
{
     ...
     */
    public function __construct($highestSeverity = null, array $notifications = array(), \CommerceFedEx\FedExPHP\Structs\VersionId $version = null, \CommerceFedEx\FedExPHP\Structs\TransactionDetail $transactionDetail = null, $faxConfirmationNumber = null)
    {
        $this
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\SignatureProofOfDeliveryFaxReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $signatureProofOfDeliveryFaxReplyNotificationsItem) {
            ...
            if (!$signatureProofOfDeliveryFaxReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($signatureProofOfDeliveryFaxReplyNotificationsItem) ? get_class($signatureProofOfDeliveryFaxReplyNotificationsItem) : gettype($signatureProofOfDeliveryFaxReplyNotificationsItem)), __LINE__);
            }
        }
