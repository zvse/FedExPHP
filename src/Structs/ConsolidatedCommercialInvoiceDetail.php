...
class ConsolidatedCommercialInvoiceDetail extends AbstractStructBase
{
     ...
     * Set Format value
     * @param \CommerceFedEx\FedExPHP\Structs\ShippingDocumentFormat $format
     * @return \CommerceFedEx\FedExPHP\Structs\ConsolidatedCommercialInvoiceDetail
     */
    ...
    public function setCustomerImageUsages(array $customerImageUsages = array())
    {
        foreach ($customerImageUsages as $consolidatedCommercialInvoiceDetailCustomerImageUsagesItem) {
            ...
            if (!$consolidatedCommercialInvoiceDetailCustomerImageUsagesItem instanceof \CommerceFedEx\FedExPHP\Structs\CustomerImageUsage) {
                throw new \InvalidArgumentException(sprintf('The CustomerImageUsages property can only contain items of \CommerceFedEx\FedExPHP\Structs\CustomerImageUsage, "%s" given', is_object($consolidatedCommercialInvoiceDetailCustomerImageUsagesItem) ? get_class($consolidatedCommercialInvoiceDetailCustomerImageUsagesItem) : gettype($consolidatedCommercialInvoiceDetailCustomerImageUsagesItem)), __LINE__);
            }
        }
