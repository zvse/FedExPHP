...
/**
 * This class stands for ConsolidatedCommercialInvoiceDetail Structs
 * Meta informations extracted from the WSDL
 * - documentation: The instructions indicating how to print the consolidated commercial invoice.
 * @subpackage Structs
 */
class ConsolidatedCommercialInvoiceDetail extends AbstractStructBase
{
    /**
     * The Format
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ConsolidatedCommercialInvoiceDetail
     * @uses ConsolidatedCommercialInvoiceDetail::setFormat()
     * @uses ConsolidatedCommercialInvoiceDetail::setCustomerImageUsages()
     * @uses ConsolidatedCommercialInvoiceDetail::setSignatureName()
     ...
     * Set Format value
     * @param \NicholasCreativeMedia\FedExPHP\Structs\ShippingDocumentFormat $format
     * @return \NicholasCreativeMedia\FedExPHP\Structs\ConsolidatedCommercialInvoiceDetail
     */
    ...
    {
        foreach ($customerImageUsages as $consolidatedCommercialInvoiceDetailCustomerImageUsagesItem) {
            // validation for constraint: itemType
            if (!$consolidatedCommercialInvoiceDetailCustomerImageUsagesItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\CustomerImageUsage) {
                throw new \InvalidArgumentException(sprintf('The CustomerImageUsages property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\CustomerImageUsage, "%s" given', is_object($consolidatedCommercialInvoiceDetailCustomerImageUsagesItem) ? get_class($consolidatedCommercialInvoiceDetailCustomerImageUsagesItem) : gettype($consolidatedCommercialInvoiceDetailCustomerImageUsagesItem)), __LINE__);
            }
        }
