...
class GetConfirmConsolidationResultsReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\GetConfirmConsolidationResultsReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $getConfirmConsolidationResultsReplyNotificationsItem) {
            ...
            if (!$getConfirmConsolidationResultsReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($getConfirmConsolidationResultsReplyNotificationsItem) ? get_class($getConfirmConsolidationResultsReplyNotificationsItem) : gettype($getConfirmConsolidationResultsReplyNotificationsItem)), __LINE__);
            }
        }
