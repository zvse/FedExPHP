...
/**
 * This class stands for GetConfirmConsolidationResultsReply Structs
 * Meta informations extracted from the WSDL
 * - type: ns:GetConfirmConsolidationResultsReply
 * @subpackage Structs
 */
class GetConfirmConsolidationResultsReply extends AbstractStructBase
{
    /**
     * The HighestSeverity
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetConfirmConsolidationResultsReply
     * @uses GetConfirmConsolidationResultsReply::setHighestSeverity()
     * @uses GetConfirmConsolidationResultsReply::setNotifications()
     * @uses GetConfirmConsolidationResultsReply::setVersion()
     * @uses GetConfirmConsolidationResultsReply::setTransactionDetail()
     * @uses GetConfirmConsolidationResultsReply::setCompletedConsolidationDetail()
     ...
     */
    public function __construct($highestSeverity = null, array $notifications = array(), \CommerceFedEx\FedExPHP\Structs\VersionId $version = null, \CommerceFedEx\FedExPHP\Structs\TransactionDetail $transactionDetail = null, \CommerceFedEx\FedExPHP\Structs\CompletedConsolidationDetail $completedConsolidationDetail = null)
    {
        $this
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\GetConfirmConsolidationResultsReply
     */
    ...
    {
        foreach ($notifications as $getConfirmConsolidationResultsReplyNotificationsItem) {
            // validation for constraint: itemType
            if (!$getConfirmConsolidationResultsReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($getConfirmConsolidationResultsReplyNotificationsItem) ? get_class($getConfirmConsolidationResultsReplyNotificationsItem) : gettype($getConfirmConsolidationResultsReplyNotificationsItem)), __LINE__);
            }
        }
