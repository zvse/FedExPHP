...
class LocationIdentificationDetail extends AbstractStructBase
{
     ...
     * @param string $type
     * @return \CommerceFedEx\FedExPHP\Structs\LocationIdentificationDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\CommerceFedEx\FedExPHP\Enums\FedExLocationType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \CommerceFedEx\FedExPHP\Enums\FedExLocationType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
