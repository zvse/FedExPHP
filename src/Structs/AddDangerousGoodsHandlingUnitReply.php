...
class AddDangerousGoodsHandlingUnitReply extends AbstractStructBase
{
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $addDangerousGoodsHandlingUnitReplyNotificationsItem) {
            ...
            if (!$addDangerousGoodsHandlingUnitReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($addDangerousGoodsHandlingUnitReplyNotificationsItem) ? get_class($addDangerousGoodsHandlingUnitReplyNotificationsItem) : gettype($addDangerousGoodsHandlingUnitReplyNotificationsItem)), __LINE__);
            }
        }
