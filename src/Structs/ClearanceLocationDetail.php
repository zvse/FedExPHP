...
class ClearanceLocationDetail extends AbstractStructBase
{
    ...
    public function setServicesSupported(array $servicesSupported = array())
    {
        foreach ($servicesSupported as $clearanceLocationDetailServicesSupportedItem) {
            ...
            if (!is_string($clearanceLocationDetailServicesSupportedItem)) {
                throw new \InvalidArgumentException(sprintf('The ServicesSupported property can only contain items of string, "%s" given', is_object($clearanceLocationDetailServicesSupportedItem) ? get_class($clearanceLocationDetailServicesSupportedItem) : gettype($clearanceLocationDetailServicesSupportedItem)), __LINE__);
            }
        }
    ...
    public function setSpecialServicesSupported(array $specialServicesSupported = array())
    {
        foreach ($specialServicesSupported as $clearanceLocationDetailSpecialServicesSupportedItem) {
            // validation for constraint: itemType
            if (!is_string($clearanceLocationDetailSpecialServicesSupportedItem)) {
                throw new \InvalidArgumentException(sprintf('The SpecialServicesSupported property can only contain items of string, "%s" given', is_object($clearanceLocationDetailSpecialServicesSupportedItem) ? get_class($clearanceLocationDetailSpecialServicesSupportedItem) : gettype($clearanceLocationDetailSpecialServicesSupportedItem)), __LINE__);
            }
        }
