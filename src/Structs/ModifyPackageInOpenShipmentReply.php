...
class ModifyPackageInOpenShipmentReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\ModifyPackageInOpenShipmentReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $modifyPackageInOpenShipmentReplyNotificationsItem) {
            ...
            if (!$modifyPackageInOpenShipmentReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($modifyPackageInOpenShipmentReplyNotificationsItem) ? get_class($modifyPackageInOpenShipmentReplyNotificationsItem) : gettype($modifyPackageInOpenShipmentReplyNotificationsItem)), __LINE__);
            }
        }
    ...
    public function setErrorLabels(array $errorLabels = array())
    {
        foreach ($errorLabels as $modifyPackageInOpenShipmentReplyErrorLabelsItem) {
            // validation for constraint: itemType
            if (!$modifyPackageInOpenShipmentReplyErrorLabelsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\ShippingDocument) {
