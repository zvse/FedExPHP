...
class GetModifyOpenShipmentResultsReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\GetModifyOpenShipmentResultsReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $getModifyOpenShipmentResultsReplyNotificationsItem) {
            ...
            if (!$getModifyOpenShipmentResultsReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($getModifyOpenShipmentResultsReplyNotificationsItem) ? get_class($getModifyOpenShipmentResultsReplyNotificationsItem) : gettype($getModifyOpenShipmentResultsReplyNotificationsItem)), __LINE__);
            }
        }
    ...
    public function setErrorLabels(array $errorLabels = array())
    {
        foreach ($errorLabels as $getModifyOpenShipmentResultsReplyErrorLabelsItem) {
            // validation for constraint: itemType
            if (!$getModifyOpenShipmentResultsReplyErrorLabelsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\ShippingDocument) {
