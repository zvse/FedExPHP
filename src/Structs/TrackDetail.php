...
class TrackDetail extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Structs\TrackPackagingDescriptionDetail
     */
    public $Packaging;
    /**
     ...
     * @uses TrackDetail::setShipmentContentPieceCount()
     * @uses TrackDetail::setPackageContentPieceCount()
     ...
     * @uses TrackDetail::setClearanceBrokerage()
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Structs\TrackPackagingDescriptionDetail $packaging
    ...
    /**
     * Get Packaging value
     * @return \NicholasCreativeMedia\FedExPHP\Structs\TrackPackagingDescriptionDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Structs\TrackDetail
     */
    public function setPackaging(\NicholasCreativeMedia\FedExPHP\Structs\TrackPackagingDescriptionDetail $packaging = null)
    {
    ...
    {
        // validation for constraint: int
        if (!is_null($shipmentContentPieceCount) && !is_numeric($shipmentContentPieceCount)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a numeric value, "%s" given', gettype($shipmentContentPieceCount)), __LINE__);
        }
    ...
    {
        // validation for constraint: int
        if (!is_null($packageContentPieceCount) && !is_numeric($packageContentPieceCount)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a numeric value, "%s" given', gettype($packageContentPieceCount)), __LINE__);
        }
