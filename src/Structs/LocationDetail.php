...
class LocationDetail extends AbstractStructBase
{
    ...
    /**
     * The PackageMaximumLimits
     * Meta informations extracted from the WSDL
     * - documentation: The maximum values for various package attributes that are supported at the location.
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Structs\LocationPackageLimitsDetail
     */
    public $PackageMaximumLimits;
    /**
     ...
     * Meta informations extracted from the WSDL
     * - documentation: Details about the FedEx administrative locations that may provide services to this location.
     * - maxOccurs: unbounded
     * - minOccurs: 0
     ...
     * @uses LocationDetail::setTimeZoneOffset()
     * @uses LocationDetail::setLocationType()
     * @uses LocationDetail::setLocationTypeForDisplay()
     * @uses LocationDetail::setAttributes()
     * @uses LocationDetail::setLocationCapabilities()
     * @uses LocationDetail::setPackageMaximumLimits()
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail[] $locationCapabilities
     * @param \NicholasCreativeMedia\FedExPHP\Structs\LocationPackageLimitsDetail $packageMaximumLimits
    ...
    public function __construct($locationId = null, $storeNumber = null, \NicholasCreativeMedia\FedExPHP\Structs\LocationContactAndAddress $locationContactAndAddress = null, $specialInstructions = null, $timeZoneOffset = null, $locationType = null, $locationTypeForDisplay = null, array $attributes = array(), array $locationCapabilities = array(), \NicholasCreativeMedia\FedExPHP\Structs\LocationPackageLimitsDetail $packageMaximumLimits = null, \NicholasCreativeMedia\FedExPHP\Structs\ClearanceLocationDetail $clearanceLocationDetail = null, array $servicingLocationDetails = array(), $acceptedCurrency = null, array $locationHolidays = array(), $mapUrl = null, $entityId = null, array $normalHours = array(), array $exceptionalHours = array(), array $hoursForEffectiveDate = array(), array $carrierDetails = array())
    {
        $this
            ...
            ->setLocationCapabilities($locationCapabilities)
            ->setPackageMaximumLimits($packageMaximumLimits)
    ...
    public function setStoreNumber($storeNumber = null)
    {
        ...
        if (!is_null($storeNumber) && !is_string($storeNumber)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($storeNumber)), __LINE__);
        }
    ...
    public function setTimeZoneOffset($timeZoneOffset = null)
    {
        ...
        if (!is_null($timeZoneOffset) && !is_string($timeZoneOffset)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($timeZoneOffset)), __LINE__);
        }
    ...
    /**
     * Get LocationCapabilities value
     * @return \NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail[]|null
     */
    public function getLocationCapabilities()
    {
        return $this->LocationCapabilities;
    }
    /**
     * Set LocationCapabilities value
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail[] $locationCapabilities
     * @return \NicholasCreativeMedia\FedExPHP\Structs\LocationDetail
     */
    public function setLocationCapabilities(array $locationCapabilities = array())
    {
        foreach ($locationCapabilities as $locationDetailLocationCapabilitiesItem) {
            // validation for constraint: itemType
            if (!$locationDetailLocationCapabilitiesItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail) {
                throw new \InvalidArgumentException(sprintf('The LocationCapabilities property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail, "%s" given', is_object($locationDetailLocationCapabilitiesItem) ? get_class($locationDetailLocationCapabilitiesItem) : gettype($locationDetailLocationCapabilitiesItem)), __LINE__);
            }
        }
    ...
    /**
     * Add item to LocationCapabilities value
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Structs\LocationDetail
     */
    public function addToLocationCapabilities(\NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail) {
            throw new \InvalidArgumentException(sprintf('The LocationCapabilities property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\LocationCapabilityDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->LocationCapabilities[] = $item;
        return $this;
    }
    /**
     * Get PackageMaximumLimits value
     * @return \NicholasCreativeMedia\FedExPHP\Structs\LocationPackageLimitsDetail|null
     */
    public function getPackageMaximumLimits()
    {
        return $this->PackageMaximumLimits;
    }
    /**
     * Set PackageMaximumLimits value
     * @param \NicholasCreativeMedia\FedExPHP\Structs\LocationPackageLimitsDetail $packageMaximumLimits
     * @return \NicholasCreativeMedia\FedExPHP\Structs\LocationDetail
     */
    public function setPackageMaximumLimits(\NicholasCreativeMedia\FedExPHP\Structs\LocationPackageLimitsDetail $packageMaximumLimits = null)
    {
