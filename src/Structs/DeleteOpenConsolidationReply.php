...
/**
 * This class stands for DeleteOpenConsolidationReply Structs
 * Meta informations extracted from the WSDL
 * - type: ns:DeleteOpenConsolidationReply
 * @subpackage Structs
 */
class DeleteOpenConsolidationReply extends AbstractStructBase
{
    /**
     * The HighestSeverity
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for DeleteOpenConsolidationReply
     * @uses DeleteOpenConsolidationReply::setHighestSeverity()
     * @uses DeleteOpenConsolidationReply::setNotifications()
     * @uses DeleteOpenConsolidationReply::setVersion()
     * @uses DeleteOpenConsolidationReply::setTransactionDetail()
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\DeleteOpenConsolidationReply
     */
    ...
    {
        foreach ($notifications as $deleteOpenConsolidationReplyNotificationsItem) {
            // validation for constraint: itemType
            if (!$deleteOpenConsolidationReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($deleteOpenConsolidationReplyNotificationsItem) ? get_class($deleteOpenConsolidationReplyNotificationsItem) : gettype($deleteOpenConsolidationReplyNotificationsItem)), __LINE__);
            }
        }
