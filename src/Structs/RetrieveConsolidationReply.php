...
class RetrieveConsolidationReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\RetrieveConsolidationReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $retrieveConsolidationReplyNotificationsItem) {
            ...
            if (!$retrieveConsolidationReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($retrieveConsolidationReplyNotificationsItem) ? get_class($retrieveConsolidationReplyNotificationsItem) : gettype($retrieveConsolidationReplyNotificationsItem)), __LINE__);
            }
        }
