...
class ShipmentReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\ShipmentReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $shipmentReplyNotificationsItem) {
            ...
            if (!$shipmentReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($shipmentReplyNotificationsItem) ? get_class($shipmentReplyNotificationsItem) : gettype($shipmentReplyNotificationsItem)), __LINE__);
            }
        }
