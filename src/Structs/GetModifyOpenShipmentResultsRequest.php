...
/**
 * This class stands for GetModifyOpenShipmentResultsRequest Structs
 * Meta informations extracted from the WSDL
 * - type: ns:GetModifyOpenShipmentResultsRequest
 * @subpackage Structs
 */
class GetModifyOpenShipmentResultsRequest extends AbstractStructBase
{
    /**
    ...
    public $JobId;
    /**
     * Constructor method for GetModifyOpenShipmentResultsRequest
     * @uses GetModifyOpenShipmentResultsRequest::setWebAuthenticationDetail()
     * @uses GetModifyOpenShipmentResultsRequest::setClientDetail()
     * @uses GetModifyOpenShipmentResultsRequest::setVersion()
     * @uses GetModifyOpenShipmentResultsRequest::setTransactionDetail()
     * @uses GetModifyOpenShipmentResultsRequest::setJobId()
     ...
     * @param \CommerceFedEx\FedExPHP\Structs\WebAuthenticationDetail $webAuthenticationDetail
     * @return \CommerceFedEx\FedExPHP\Structs\GetModifyOpenShipmentResultsRequest
     */
