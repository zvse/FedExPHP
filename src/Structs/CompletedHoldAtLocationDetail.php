...
class CompletedHoldAtLocationDetail extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Structs\ContactAndAddress $holdingLocation = null, $holdingLocationType = null, $holdingLocationTypeForDisplay = null)
    {
        $this
