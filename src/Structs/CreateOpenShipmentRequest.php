...
class CreateOpenShipmentRequest extends AbstractStructBase
{
     ...
     * @param \CommerceFedEx\FedExPHP\Structs\WebAuthenticationDetail $webAuthenticationDetail
     * @return \CommerceFedEx\FedExPHP\Structs\CreateOpenShipmentRequest
     */
    ...
    public function setActions(array $actions = array())
    {
        ...
        foreach ($actions as $createOpenShipmentRequestActionsItem) {
            if (!\CommerceFedEx\FedExPHP\Enums\CreateOpenShipmentActionType::valueIsValid($createOpenShipmentRequestActionsItem)) {
