...
class ValidateOpenShipmentReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\ValidateOpenShipmentReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $validateOpenShipmentReplyNotificationsItem) {
            ...
            if (!$validateOpenShipmentReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($validateOpenShipmentReplyNotificationsItem) ? get_class($validateOpenShipmentReplyNotificationsItem) : gettype($validateOpenShipmentReplyNotificationsItem)), __LINE__);
            }
        }
