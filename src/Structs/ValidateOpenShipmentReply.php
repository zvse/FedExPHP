...
/**
 * This class stands for ValidateOpenShipmentReply Structs
 * Meta informations extracted from the WSDL
 * - type: ns:ValidateOpenShipmentReply
 * @subpackage Structs
 */
class ValidateOpenShipmentReply extends AbstractStructBase
{
    /**
     * The HighestSeverity
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ValidateOpenShipmentReply
     * @uses ValidateOpenShipmentReply::setHighestSeverity()
     * @uses ValidateOpenShipmentReply::setNotifications()
     * @uses ValidateOpenShipmentReply::setVersion()
     * @uses ValidateOpenShipmentReply::setTransactionDetail()
     * @uses ValidateOpenShipmentReply::setAdvisoryDetail()
     ...
     */
    public function __construct($highestSeverity = null, array $notifications = array(), \NicholasCreativeMedia\FedExPHP\Structs\VersionId $version = null, \NicholasCreativeMedia\FedExPHP\Structs\TransactionDetail $transactionDetail = null, \NicholasCreativeMedia\FedExPHP\Structs\ShipmentAdvisoryDetail $advisoryDetail = null)
    {
        $this
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Structs\ValidateOpenShipmentReply
     */
    ...
    {
        foreach ($notifications as $validateOpenShipmentReplyNotificationsItem) {
            // validation for constraint: itemType
            if (!$validateOpenShipmentReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Structs\Notification, "%s" given', is_object($validateOpenShipmentReplyNotificationsItem) ? get_class($validateOpenShipmentReplyNotificationsItem) : gettype($validateOpenShipmentReplyNotificationsItem)), __LINE__);
            }
        }
