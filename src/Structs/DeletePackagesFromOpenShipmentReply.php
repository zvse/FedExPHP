...
/**
 * This class stands for DeletePackagesFromOpenShipmentReply Structs
 * Meta informations extracted from the WSDL
 * - type: ns:DeletePackagesFromOpenShipmentReply
 * @subpackage Structs
 */
class DeletePackagesFromOpenShipmentReply extends AbstractStructBase
{
    /**
     * The HighestSeverity
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for DeletePackagesFromOpenShipmentReply
     * @uses DeletePackagesFromOpenShipmentReply::setHighestSeverity()
     * @uses DeletePackagesFromOpenShipmentReply::setNotifications()
     * @uses DeletePackagesFromOpenShipmentReply::setVersion()
