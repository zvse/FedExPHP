...
class GetConfirmOpenShipmentResultsReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\GetConfirmOpenShipmentResultsReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $getConfirmOpenShipmentResultsReplyNotificationsItem) {
            ...
            if (!$getConfirmOpenShipmentResultsReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($getConfirmOpenShipmentResultsReplyNotificationsItem) ? get_class($getConfirmOpenShipmentResultsReplyNotificationsItem) : gettype($getConfirmOpenShipmentResultsReplyNotificationsItem)), __LINE__);
            }
        }
    ...
    public function setErrorLabels(array $errorLabels = array())
    {
        foreach ($errorLabels as $getConfirmOpenShipmentResultsReplyErrorLabelsItem) {
            // validation for constraint: itemType
            if (!$getConfirmOpenShipmentResultsReplyErrorLabelsItem instanceof \CommerceFedEx\FedExPHP\Structs\ShippingDocument) {
