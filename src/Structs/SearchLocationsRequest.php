...
class SearchLocationsRequest extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - documentation: The account number of the shipper. This is the account number for which restrictions and privileges will be applied.
     * - minOccurs: 0
     * @var string
     */
     ...
     * @uses SearchLocationsRequest::setShipperAccountNumber()
    ...
    public function setShipperAccountNumber($shipperAccountNumber = null)
    {
        ...
        if (!is_null($shipperAccountNumber) && !is_string($shipperAccountNumber)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($shipperAccountNumber)), __LINE__);
        }
