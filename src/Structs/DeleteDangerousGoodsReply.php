...
class DeleteDangerousGoodsReply extends AbstractStructBase
{
     ...
     * @param string $highestSeverity
     * @return \CommerceFedEx\FedExPHP\Structs\DeleteDangerousGoodsReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $deleteDangerousGoodsReplyNotificationsItem) {
            ...
            if (!$deleteDangerousGoodsReplyNotificationsItem instanceof \CommerceFedEx\FedExPHP\Structs\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \CommerceFedEx\FedExPHP\Structs\Notification, "%s" given', is_object($deleteDangerousGoodsReplyNotificationsItem) ? get_class($deleteDangerousGoodsReplyNotificationsItem) : gettype($deleteDangerousGoodsReplyNotificationsItem)), __LINE__);
            }
        }
